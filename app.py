...
hf_api_key = st.sidebar.text_input("HuggingFace Hub API Key", type="password")
...
with st.form("my_form"):
    ...
    if not hf_api_key.startswith("hf_"):
        st.warning("Please enter your valid HuggingFace Hub API key!", icon="⚠")
        
    if not groq_api_key.startswith("gsk_"):
        st.warning("Please enter your valid Groq API key!", icon="⚠")
    ...
    if submitted and uploaded_file and st.session_state.get("chain") and hf_api_key.startswith("hf_") and groq_api_key.startswith("gsk_"):
...
with st.expander("View Tips and Instructions"):
    ...
    st.markdown("""
                ...
                • Enter your HuggingFaceHub and Groq API keys.
